...
namespace CAR_SYSTEM
{
    partial class CustomerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbType.Items.AddRange(new object[] { "종합", "종합 NOx", "정기", "배출면제" });
            cmbType.Name             = "cmbType";
            cmbType.TabIndex         = 4;

            cmbFuel.DropDownStyle    = ComboBoxStyle.DropDownList;
            cmbFuel.FormattingEnabled = true;
            cmbFuel.Items.AddRange(new object[] { "가솔린", "디젤", "LPG", "가솔린 하이브리드", "LPG 하이브리드", "전기", "수소", "CNG" });
            ...
            // Row 0 — header (span 4)
            Panel pHdr = new Panel { Dock = DockStyle.Fill, BackColor = Color.FromArgb(30, 30, 52) };
            ...
            // Row 2 — 검사종류 | 유종 | 구동방식 | 배출가스
            tblForm.Controls.Add(MkCell("검사종류", cmbType),    0, 2);
            ...
            Panel pBtns = new Panel { Dock = DockStyle.Fill, BackColor = Color.FromArgb(22, 22, 30), Padding = new Padding(8, 4, 0, 0) };
