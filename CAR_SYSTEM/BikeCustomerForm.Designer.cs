...
namespace CAR_SYSTEM
{
    partial class BikeCustomerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tblForm.Controls.Add(pTypeCell, 3, 1);

            // Row 2 — 검사주기 | 접수일시 | 유효만료일 | (blank)
            tblForm.Controls.Add(MkCell("검사주기",  cmbCycle),  0, 2);
            tblForm.Controls.Add(MkCell("접수일시",  dtpDate),   1, 2);
            tblForm.Controls.Add(MkCell("유효만료일", txtExpiry), 2, 2);

            // Row 3 — 수수료 | 결재구분 | 비고 (span 2)
            tblForm.Controls.Add(MkCell("수수료",   cmbFee),    0, 3);
            tblForm.Controls.Add(MkCell("결재구분", cmbPayment), 1, 3);
            Panel pMemo = MkCell("비고", txtMemo);
            tblForm.Controls.Add(pMemo, 2, 3);
            tblForm.SetColumnSpan(pMemo, 2);

            // Row 4 — buttons (span 4)
            ...
            tblForm.Controls.Add(pBtns, 0, 4);
